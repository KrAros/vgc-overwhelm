...
describe('A — le voci che aspettano una trascrizione sono ancora aperte', () => {
  ...
  it.runIf(vendorPresente)('e le cinque che restano sono ancora cinque', () => {
    ...
    expect(resteDaFare()).toHaveLength(5)
  })
  ...
  it('`gapNoti.json` adesso ha anche le mosse, e il badge le avvisa', () => {
    ...
    expect(gapNoti.mosse.length).toBe(5)
    expect(gapNoti.meta.mosseNelGap).toBe(5)
  })
