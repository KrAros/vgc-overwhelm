...
describe('A — le voci che aspettano una trascrizione sono ancora aperte', () => {
  ...
  it.runIf(vendorPresente)('e le sei che restano sono ancora sei', () => {
    ...
    expect(resteDaFare()).toHaveLength(6)
  })
  ...
  it('`gapNoti.json` adesso ha anche le mosse, e il badge le avvisa', () => {
    ...
    expect(gapNoti.mosse.length).toBe(6)
    expect(gapNoti.meta.mosseNelGap).toBe(6)
  })
